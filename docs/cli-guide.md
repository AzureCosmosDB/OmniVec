...
```bash
omnivec config set server http://20.242.139.166
```
...
omnivec-api         1/1    Running  cdbmvsacr4cc259.azurecr.io/omnivec-api:v50  1
omnivec-controller  1/1    Running  cdbmvsacr4cc259.azurecr.io/omnivec-api:v49  1
omnivec-worker      7/7    Running  cdbmvsacr4cc259.azurecr.io/omnivec-api:v49  7
```
