...
SYSTEM_PROMPT = (
    ...
    "confidence, unknowns and runbook, not guesses. For a specific symptom, error "
    "signature, connector, deployment, queue, identity, checkpoint or integrity issue, "
    "call get_troubleshooting_runbook after diagnosis and apply only entries supported "
    "by current evidence. A runbook match is guidance, not proof of root cause. "
    "Diagnose -> choose one concrete "
