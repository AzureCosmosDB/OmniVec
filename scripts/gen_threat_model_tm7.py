...
ELEMENTS: list[dict] = [
    ...
    {"k": "process",  "name": "omnivec-web (Next.js)",            "x": 280,  "y": 260},
    {"k": "process",  "name": "omnivec-api (FastAPI)",            "x": 480,  "y": 260},
    {"k": "process",  "name": "omnivec-search (Go)",              "x": 680,  "y": 260},
    {"k": "process",  "name": "docgrok-router (Rust)",            "x": 280,  "y": 500},
    {"k": "process",  "name": "docgrok-pipeline-worker",          "x": 480,  "y": 500},
    {"k": "process",  "name": "omnivec-ingestor (.NET)",          "x": 280,  "y": 760},
    {"k": "process",  "name": "in-cluster embedders",             "x": 680,  "y": 500},
    {"k": "process",  "name": "Azure OpenAI",                     "x": 940,  "y": 260},
    {"k": "store",    "name": "CosmosDB omnivec.metadata",        "x": 940,  "y": 480},
    {"k": "store",    "name": "Customer CosmosDB (vectors destination)", "x": 940, "y": 980},
    {"k": "store",    "name": "Customer Blob (attachments source)", "x": 1160, "y": 980},
    {"k": "store",    "name": "Azure Key Vault",                  "x": 1160, "y": 260},
    {"k": "store",    "name": "Azure Service Bus",                "x": 1160, "y": 480},
    {"k": "store",    "name": "Customer CosmosDB (source)",       "x": 940,  "y": 760},
    {"k": "store",    "name": "Customer Blob source",             "x": 1160, "y": 760},
    {"k": "process",  "name": "omnivec-dotnet-worker (queue)",    "x": 480,  "y": 760},
]

TBS: list[dict] = [
    {"name": "TB-1 Internet / AAD",         "x": 30,   "y": 320, "w": 220,  "h": 160},
    {"name": "TB-2 AKS cluster",            "x": 250,  "y": 220, "w": 560,  "h": 720},
    {"name": "TB-2a Web / API tier",        "x": 260,  "y": 230, "w": 540,  "h": 200},
    {"name": "TB-2b DocGrok tier",          "x": 260,  "y": 470, "w": 540,  "h": 200},
    {"name": "TB-2c Ingestor tier",         "x": 260,  "y": 730, "w": 360,  "h": 200},
    {"name": "TB-3 Azure managed services", "x": 920,  "y": 230, "w": 360,  "h": 320},
    {"name": "TB-4 Customer-owned",         "x": 920,  "y": 730, "w": 360,  "h": 360},
]
