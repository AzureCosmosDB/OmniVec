...
ELEMENTS: list[dict] = [
    {"k": "external", "name": "End-user browser",                 "x": 60,   "y": 460},
    {"k": "process",  "name": "omnivec-web (Next.js)",            "x": 320,  "y": 280},
    {"k": "process",  "name": "omnivec-api (FastAPI)",            "x": 580,  "y": 280},
    {"k": "process",  "name": "omnivec-search (Go)",              "x": 840,  "y": 280},
    {"k": "process",  "name": "docgrok-router (Rust)",            "x": 320,  "y": 580},
    {"k": "process",  "name": "docgrok-pipeline-worker",          "x": 580,  "y": 580},
    {"k": "process",  "name": "omnivec-ingestor (.NET)",          "x": 320,  "y": 880},
    {"k": "process",  "name": "in-cluster embedders",             "x": 840,  "y": 580},
    {"k": "process",  "name": "Azure OpenAI",                     "x": 1140, "y": 280},
    {"k": "store",    "name": "CosmosDB omnivec.metadata",        "x": 1140, "y": 540},
    {"k": "store",    "name": "Customer CosmosDB (vectors destination)", "x": 1140, "y": 1140},
    {"k": "store",    "name": "Customer Blob (attachments source)", "x": 1400, "y": 1140},
    {"k": "store",    "name": "Azure Key Vault",                  "x": 1400, "y": 280},
    {"k": "store",    "name": "Azure Service Bus",                "x": 1400, "y": 540},
    {"k": "store",    "name": "Customer CosmosDB (source)",       "x": 1140, "y": 880},
    {"k": "store",    "name": "Customer Blob source",             "x": 1400, "y": 880},
    {"k": "process",  "name": "omnivec-dotnet-worker (queue)",    "x": 580,  "y": 880},
    {"k": "external", "name": "Azure AD (login.microsoftonline.com)", "x": 60, "y": 220},
]

TBS: list[dict] = [
    {"name": "TB-1 Internet / AAD",         "x": 30,   "y": 180, "w": 240,  "h": 400},
    {"name": "TB-2 AKS cluster",            "x": 290,  "y": 240, "w": 680,  "h": 820},
    {"name": "TB-2a Web / API tier",        "x": 300,  "y": 250, "w": 660,  "h": 200},
    {"name": "TB-2b DocGrok tier",          "x": 300,  "y": 550, "w": 660,  "h": 200},
    {"name": "TB-2c Ingestor tier",         "x": 300,  "y": 850, "w": 420,  "h": 200},
    {"name": "TB-3 Azure managed services", "x": 1110, "y": 250, "w": 400,  "h": 440},
    {"name": "TB-4 Customer-owned",         "x": 1110, "y": 850, "w": 400,  "h": 440},
]
